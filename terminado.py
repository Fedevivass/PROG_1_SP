...
cuadro = crear_elemento_juego(r"C:\Users\feder\Desktop\juego progra\textura_pregunta.jpg",250,50,200,200)
guardado = crear_elemento_juego(r"C:\Users\feder\Desktop\juego progra\textura_pregunta.jpg",200,50,200,300)
fondo_pantalla = pygame.transform.scale(pygame.image.load(r"C:\Users\feder\Desktop\juego progra\fondo.jpg"),PANTALLA)
    ...
    for evento in cola_eventos:
        if evento.type == pygame.QUIT:
            ...
            if letra_presionada == "backspace" and len(datos_juego["nombre"]) > 0:
                ...
                print(datos_juego["nombre"])
                limpiar_superficie(cuadro,r"C:\Users\feder\Desktop\juego progra\textura_pregunta.jpg",250,50)
